/*
 ...
 Source Schema         : hahah2

 Target Server Type    : MySQL
 Target Server Version : 80037 (8.0.37)
 File Encoding         : 65001

 Date: 09/06/2024 01:14:20
*/
...
INSERT INTO `sys_menu` VALUES (2, '系统监控', 0, 2, 'monitor', NULL, '', 1, 0, 'M', '1', '0', '', 'monitor', 'admin', '2024-05-09 17:26:07', 'admin', '2024-06-08 18:24:37', '系统监控目录');
INSERT INTO `sys_menu` VALUES (3, '系统工具', 0, 3, 'tool', NULL, '', 1, 0, 'M', '1', '0', '', 'tool', 'admin', '2024-05-09 17:26:07', 'admin', '2024-06-08 16:36:59', '系统工具目录');
...
INSERT INTO `sys_menu` VALUES (103, '部门管理', 1, 4, 'dept', 'system/dept/index', '', 1, 0, 'C', '1', '1', 'system:dept:list', 'tree', 'admin', '2024-05-09 17:26:07', 'admin', '2024-06-08 16:32:32', '部门管理菜单');
INSERT INTO `sys_menu` VALUES (104, '岗位管理', 1, 5, 'post', 'system/post/index', '', 1, 0, 'C', '1', '1', 'system:post:list', 'post', 'admin', '2024-05-09 17:26:07', 'admin', '2024-06-08 16:32:24', '岗位管理菜单');
INSERT INTO `sys_menu` VALUES (105, '字典管理', 1, 6, 'dict', 'system/dict/index', '', 1, 0, 'C', '1', '1', 'system:dict:list', 'dict', 'admin', '2024-05-09 17:26:07', 'admin', '2024-06-08 16:32:53', '字典管理菜单');
INSERT INTO `sys_menu` VALUES (106, '参数设置', 1, 7, 'config', 'system/config/index', '', 1, 0, 'C', '1', '1', 'system:config:list', 'edit', 'admin', '2024-05-09 17:26:07', 'admin', '2024-06-08 16:33:13', '参数设置菜单');
...
INSERT INTO `sys_menu` VALUES (108, '日志管理', 1, 9, 'log', '', '', 1, 0, 'M', '1', '0', '', 'log', 'admin', '2024-05-09 17:26:07', 'admin', '2024-06-08 16:33:36', '日志管理菜单');
...
) ENGINE = InnoDB AUTO_INCREMENT = 471 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '操作日志记录' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 338 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '评论表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sys_remark
-- ----------------------------
INSERT INTO `sys_remark` VALUES (289, 0, '', 1, '机器学习', '0', '1', '2024-06-08 21:14:08', '', NULL, '', NULL, 0, NULL, NULL, NULL, '1');
INSERT INTO `sys_remark` VALUES (290, 289, '', 2, '机器学习 - 李祖超', '0', '1', '2024-06-08 21:14:20', '', '2024-06-08 22:28:18', '评分：9.60', NULL, 0, NULL, NULL, NULL, '1');
...
INSERT INTO `sys_remark` VALUES (298, 297, '', 2, 'CSAPP - 蔡朝晖', '0', '1', '2024-06-08 21:17:00', '', '2024-06-08 22:32:34', '评分：10.00', NULL, 0, NULL, NULL, NULL, '1');
...
INSERT INTO `sys_remark` VALUES (301, 300, '', 2, '计算机网络 - 黄传河', '0', '1', '2024-06-08 21:20:57', '', '2024-06-08 22:25:04', '评分：10.00', NULL, 0, NULL, NULL, NULL, '1');
INSERT INTO `sys_remark` VALUES (302, 290, '', 3, '机器学习 - 李祖超', '0', '1', '2024-06-08 21:21:20', '', '2024-06-08 22:36:49', 'zmjjkk:没上过李老师的课，李老师讲课怎么样啊xdm', 10, 2, 0, NULL, NULL, '1');
...
INSERT INTO `sys_remark` VALUES (305, 295, '', 3, '线性代数 - 江宁', '0', '1', '2024-06-08 21:24:03', '', '2024-06-08 21:46:01', 'zmjjkk:教师教学在书面浅显知识的基础上，进一步扩大了教学的知识的深度及广度，扩大了学生知识面，并且多方面培养学生的思考问题的能力', 10, 1, 0, NULL, NULL, '1');
...
INSERT INTO `sys_remark` VALUES (310, 290, '', 3, '机器学习 - 李祖超', '0', '100', '2024-06-08 21:39:54', '', '2024-06-08 22:04:41', '峡谷帅哥:大作业不会做www', 8, 2, 0, NULL, NULL, '3');
...
INSERT INTO `sys_remark` VALUES (312, 292, '', 3, '操作系统 - 郑鹏', '0', '100', '2024-06-08 21:44:35', '', '2024-06-08 22:04:45', '峡谷帅哥:郑老师讲课内容新颖，独特，有个性。教师授课表现出来的激情和精神可以深深吸引并打动学生，希望我们的老师可以继续创新，造出更多的精品课。', 10, 2, 0, NULL, NULL, '3');
...
INSERT INTO `sys_remark` VALUES (314, 296, '', 3, '线性代数 - 黄正华', '0', '100', '2024-06-08 21:49:34', '', NULL, '峡谷帅哥:老师在授课中，内容深且广，涵盖面广，能联系古今，结合时代背景。', 10, 0, 0, NULL, NULL, '3');
...
INSERT INTO `sys_remark` VALUES (318, 290, '', 3, '机器学习 - 李祖超', '0', '102', '2024-06-08 22:02:56', '', '2024-06-09 01:11:15', '水军一号:我是水军一号！李老师讲得好', 10, 1, 1, NULL, NULL, '3');
...
INSERT INTO `sys_remark` VALUES (327, 290, '', 3, '机器学习 - 李祖超', '0', '104', '2024-06-08 22:21:10', '', NULL, '水军三号:李老师赛高！', 10, 0, 0, NULL, NULL, '3');
...
INSERT INTO `sys_remark` VALUES (331, 290, '', 3, '机器学习 - 李祖超', '0', '106', '2024-06-08 22:28:18', '', '2024-06-08 22:32:46', '李祖超:感谢同学们的喜爱，同时也非常感谢给我提出宝贵建议的同学们，我会认真听取同学们的建议进行改进！！[抱拳][抱拳]', NULL, 2, 0, NULL, NULL, '102');
...
INSERT INTO `sys_role` VALUES (2, '普通角色', 'common', 2, '2', 1, 1, '0', '0', 'admin', '2024-05-08 17:19:31', 'admin', '2024-06-08 18:01:22', '普通角色');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', 'zmjjkk', '00', 'shuaige@163.com', '15888888888', '0', '/profile/avatar/2024/06/08/profile_20240608175053A001.jpg', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2024-06-09 01:10:53', 'admin', '2024-05-08 17:19:30', '', '2024-06-09 01:10:52', '管理员');
...
INSERT INTO `sys_user` VALUES (102, NULL, '水军一号', '水军一号', '00', '', '', '0', '', '$2a$10$zSxEHO5AMPS0IQJ/qgGPPupy3EMCLiRE23eayma7GeSoVUF1lEzbS', '0', '0', '127.0.0.1', '2024-06-09 01:06:20', 'admin', '2024-06-08 21:54:32', '', '2024-06-09 01:06:20', NULL);
...
INSERT INTO `sys_user_remark` VALUES (302, 100, 1);
INSERT INTO `sys_user_remark` VALUES (302, 102, 1);
...
INSERT INTO `sys_user_remark` VALUES (318, 1, 2);
...
INSERT INTO `sys_user_remark` VALUES (331, 105, 1);
INSERT INTO `sys_user_remark` VALUES (331, 106, 1);
